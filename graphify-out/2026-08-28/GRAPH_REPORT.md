# Graph Report - memoria  (2026-08-28)

## Corpus Check
- 270 files · ~137,083 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1191 nodes · 1989 edges · 185 communities (79 shown, 106 thin omitted)
...
## Communities (185 total, 106 thin omitted)
...
Cohesion: 0.06
Nodes (44): FloatingEdge, nodeRect(), sameRect(), studentNodeStatus, RoadmapDependencyEdgeData, roadmapEdgeTypes, RoadmapFlowEdge, mapRoadmapGraph() (+36 more)
...
Cohesion: 0.13
Nodes (22): NodeInput, NodeTypeInput, NodeUpdate, ResourceInput, RoadmapEditorProps, PendingDeletion, RoadmapEditorSelectedNode(), Props (+14 more)

### Community 5 - "layout.tsx"
Cohesion: 0.07
Nodes (35): fixtureOfferingIds, ids, main(), nodeId(), predefinedNodeTypes, prisma, resetDevelopmentData(), studentId() (+27 more)
...
Cohesion: 0.06
Nodes (48): AcademicOverviewPage(), AcademicTermSection(), courseKey(), groupCoursesByAcademicTerm(), localOverviewCourse(), OverviewCourse, ParticipationWithCourse, TermGroup (+40 more)
...
Cohesion: 0.20
Nodes (10): Field(), FieldContent(), FieldDescription(), FieldError(), FieldLegend(), FieldSeparator(), FieldSet(), FieldTitle() (+2 more)
...
Cohesion: 0.13
Nodes (15): class-variance-authority, clsx, lucide-react, neverthrow, dependencies, class-variance-authority, clsx, lucide-react (+7 more)

### Community 15 - "utils.ts"
Cohesion: 0.15
Nodes (14): courseBenefits, sampleRoute, RoadmapFlowNode, RoadmapNode(), RoadmapNodeData, Badge(), badgeVariants, Card() (+6 more)
...
Cohesion: 0.22
Nodes (9): dotenv, @eslint/js, devDependencies, dotenv, @eslint/js, @playwright/mcp, @typescript-eslint/parser, @playwright/mcp (+1 more)
...
### Community 50 - "RoadmapEditorNodeCreator.tsx"
Cohesion: 0.18
Nodes (13): Props, RoadmapEditorNodeCreator(), Checkbox(), Dialog(), DialogClose(), DialogContent(), DialogDescription(), DialogFooter() (+5 more)
...
Cohesion: 0.29
Nodes (9): Props, RoadmapErrorToast(), Alert(), AlertAction(), AlertDescription(), AlertTitle(), alertVariants, Button() (+1 more)

### Community 114 - "Registry Authoring and Addresses"
Cohesion: 0.22
...
### Community 121 - "RoadmapEditorSelectedNode.tsx"
Cohesion: 0.16
Nodes (19): Props, RoadmapEditorNodeTypes(), EditorSection(), inputClassName, NodeTypeSelect(), Props, FieldGroup(), FieldLabel() (+11 more)
...
### Community 185 - "shadcn UI Skill"
Cohesion: 0.33
Nodes (4): Component Composition Rules, Forms and Inputs Rules, Styling and Customization Rules, shadcn UI Skill

### Community 186 - "shadcn CLI Reference"
Cohesion: 0.29
Nodes (5): Contents, Presets, shadcn CLI Reference, Switching Presets, Templates

### Community 187 - "Customizing Components"
Cohesion: 0.40
...
- **Why does `cn()` connect `cn` to `RoadmapGraph.tsx`, `RoadmapCanvas.tsx`, `layout.tsx`, `StudentNodeDetail.tsx`, `field.tsx`, `utils.ts`, `button.tsx`, `RoadmapEditorNodeCreator.tsx`, `RoadmapEditorSelectedNode.tsx`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `devDependencies` to `package.json`, `globals`, `dotenv-cli`, `eslint`, `@eslint/compat`, `eslint-config-next`, `eslint-config-prettier`, `@eslint/css`, `eslint-plugin-neverthrow`, `eslint-plugin-playwright`, `eslint-plugin-testing-library`, `@tailwindcss/postcss`, `jsdom`, `@playwright/test`, `postcss`, `prettier`, `prettier-plugin-tailwindcss`, `prisma`, `shadcn`, `tailwindcss`, `@testing-library/react`, `@testing-library/user-event`, `tsx`, `tw-animate-css`, `@types/node`, `@types/react`, `@types/react-dom`, `typescript`, `typescript-eslint`, `vitest`, `@vitest/eslint-plugin`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `developmentEnvironmentEnabled()` connect `layout.tsx` to `roadmap-editor.ts`?**
