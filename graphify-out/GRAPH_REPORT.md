...
## Corpus Check
- 270 files · ~137,075 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1191 nodes · 1988 edges · 185 communities (78 shown, 107 thin omitted)
...
## Communities (185 total, 107 thin omitted)
...
Cohesion: 0.05
Nodes (48): RoadmapDependencyEdgeData, roadmapEdgeTypes, RoadmapFlowEdge, FloatingEdge, nodeRect(), sameRect(), mapRoadmapGraph(), nodeStatus() (+40 more)
...
### Community 3 - "RoadmapEditor.tsx"
Cohesion: 0.15
Nodes (21): SessionButton(), AlertDialog(), AlertDialogAction(), AlertDialogCancel(), AlertDialogContent(), AlertDialogDescription(), AlertDialogFooter(), AlertDialogHeader() (+13 more)

### Community 5 - "mufasa.ts"
Cohesion: 0.13
Nodes (23): fixtureOfferingIds, ids, main(), nodeId(), predefinedNodeTypes, prisma, resetDevelopmentData(), studentId() (+15 more)
...
### Community 8 - "RoadmapCanvas.tsx"
Cohesion: 0.05
Nodes (53): AcademicOverviewPage(), AcademicTermSection(), courseKey(), groupCoursesByAcademicTerm(), localOverviewCourse(), OverviewCourse, ParticipationWithCourse, TermGroup (+45 more)
...
Cohesion: 0.14
Nodes (15): Field(), FieldContent(), FieldDescription(), FieldError(), FieldGroup(), FieldLabel(), FieldLegend(), FieldSeparator() (+7 more)
...
### Community 15 - "NodeDetail.tsx"
Cohesion: 0.12
Nodes (25): Item(), ItemActions(), ItemContent(), ItemDescription(), ItemFooter(), ItemGroup(), ItemHeader(), ItemMedia() (+17 more)
...
Cohesion: 0.22
Nodes (9): @eslint/compat, @eslint/js, devDependencies, @eslint/compat, @eslint/js, @playwright/mcp, @typescript-eslint/parser, @playwright/mcp (+1 more)
...
### Community 50 - "NodeCreator.tsx"
Cohesion: 0.18
Nodes (13): Checkbox(), Dialog(), DialogClose(), DialogContent(), DialogDescription(), DialogFooter(), DialogHeader(), DialogOverlay() (+5 more)
...
### Community 121 - "NodeDetailsEditor.tsx"
Cohesion: 0.22
Nodes (14): SelectContent(), SelectGroup(), SelectItem(), SelectLabel(), SelectScrollDownButton(), SelectScrollUpButton(), SelectSeparator(), SelectTrigger() (+6 more)
...
- **Why does `cn()` connect `cn` to `RoadmapGraph.tsx`, `RoadmapEditor.tsx`, `RoadmapCanvas.tsx`, `field.tsx`, `NodeDetail.tsx`, `NodeCreator.tsx`, `NodeDetailsEditor.tsx`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `devDependencies` to `package.json`, `globals`, `dotenv-cli`, `eslint`, `eslint-config-next`, `eslint-config-prettier`, `@eslint/css`, `eslint-plugin-neverthrow`, `eslint-plugin-playwright`, `eslint-plugin-testing-library`, `@tailwindcss/postcss`, `jsdom`, `@playwright/test`, `postcss`, `prettier`, `prettier-plugin-tailwindcss`, `prisma`, `shadcn`, `tailwindcss`, `dotenv`, `@testing-library/react`, `@testing-library/user-event`, `tsx`, `tw-animate-css`, `@types/node`, `@types/react`, `@types/react-dom`, `typescript`, `typescript-eslint`, `vitest`, `@vitest/eslint-plugin`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `developmentEnvironmentEnabled()` connect `mufasa.ts` to `roadmap-editor.ts`, `RoadmapCanvas.tsx`?**
