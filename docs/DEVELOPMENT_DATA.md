...
3. Ejecuta `pnpm dev:data:reset`. El comando aplica las migraciones al contenedor de desarrollo y carga los datos ficticios, incluidos los tipos de nodo predefinidos.
